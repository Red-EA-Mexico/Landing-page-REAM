...
(function () {
  ...
  const FALLBACK_PROJECTS = [
    { id: 'proyecto-1', nombre: 'AI Safety in Mexico: A Pilot Survey in Yucatan', areaTematica: 'AI Safety-Governance', descripcion: 'Este estudio presenta los resultados de una encuesta piloto realizada con académicos en Yucatán para comprender las perspectivas locales sobre la seguridad de la IA.', estado: 'Publicado', equipo: 'AI Safety México, Centro GEO, Universidad Politécnica de Yucatán', resultadosMedibles: 'Paper publicado en Research in computer Science, atención mediática en más de 10 medios de comunicación', slug: 'AI safety Survey' },
    { id: 'proyecto-2', nombre: 'Guía de carreras de alto impacto', areaTematica: 'Desarrollo de talento', descripcion: 'Recursos y mentoría para profesionales que buscan orientar su carrera hacia el mayor impacto posible.', estado: 'Activo', equipo: 'EA ITAM, EA Tec Monterrey', resultadosMedibles: '50+ personas asesoradas, 8 sesiones realizadas', slug: 'guia-carreras-alto-impacto' },
    { id: 'proyecto-3', nombre: 'Fondo de becas para formación en EA', areaTematica: 'Educación', descripcion: 'Becas para cursos y conferencias de altruismo eficaz dirigidas a miembros de la red.', estado: 'En desarrollo', equipo: 'Coordinación nacional', resultadosMedibles: 'En fase de diseño de criterios y convocatoria', slug: 'fondo-becas-ea' },
    { id: 'proyecto-4', nombre: 'Sistema de seguimiento de grupos', areaTematica: 'Coordinación', descripcion: 'Herramientas y procesos para medir actividad, retención y crecimiento de los grupos locales.', estado: 'Finalizado', equipo: 'EA Monterrey, voluntarios', resultadosMedibles: 'Dashboard en uso por 6 grupos', slug: 'seguimiento-grupos' },
  ];
